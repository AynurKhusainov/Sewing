...
import com.example.myapplication.Designer.MyOrderNow;
...
public class Catalog extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        modelAdapter2 = new CatalogAdapter(getActivity(), R.layout.item, arrayList);
    ...
    public void EventChangeListener() {
        ...
        db.collection("orders").orderBy("order_term", Query.Direction.ASCENDING).whereEqualTo("status","completed")
